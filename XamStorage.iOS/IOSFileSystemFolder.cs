...
namespace XamStorage.iOS
{
    ...
    public class IOSFileSystemFolder : IFolder
    {
        ...
        public IOSFileSystemFolder(string path, bool canDelete,Storage storage)
        {
        ...
        public IOSFileSystemFolder(string path,Storage storage)
        ...
        public async Task<IFile> GetFileAsync(string name, CancellationToken cancellationToken)
        {
            ...
            var ret = new IOSFileSystemFile(path);
            return ret;
        }
        ...
        public async Task<IList<IFile>> GetFilesAsync(CancellationToken cancellationToken)
        {
            await AwaitExtensions.SwitchOffMainThreadAsync(cancellationToken);
            EnsureExists();
            IList<IFile> ret = Directory.GetFiles(Path).Select(f => new IOSFileSystemFile(f)).ToList<IFile>().AsReadOnly();
            return ret;
        }
        ...
        public async Task<IFolder> CreateFolderAsync(string desiredName, CreationCollisionOption option, CancellationToken cancellationToken)
        {
            ...
            var ret = new IOSFileSystemFolder(newPath, true, Storage);
            return ret;
        }
        ...
        public async Task<IFolder> GetFolderAsync(string name, CancellationToken cancellationToken)
        {
            ...
            var ret = new IOSFileSystemFolder(path, true, Storage);
            return ret;
        }
        ...
        public async Task<IList<IFolder>> GetFoldersAsync(CancellationToken cancellationToken)
        {
            await AwaitExtensions.SwitchOffMainThreadAsync(cancellationToken);
            EnsureExists();
            IList<IFolder> ret = Directory.GetDirectories(Path).Select(d => new IOSFileSystemFolder(d, true, Storage)).ToList<IFolder>().AsReadOnly();
            return ret;
        }
