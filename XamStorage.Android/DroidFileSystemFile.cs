...
{
    /// <summary>
    /// Represents a file in the <see cref="DroidFileSystemFile"/>
    /// </summary>
    [DebuggerDisplay("Name = {_name}")]
    public class DroidFileSystemFile : IFile
    {
        string _name;
        string _path;

        /// <summary>
        /// Creates a new <see cref="DroidFileSystemFile"/> corresponding to the specified path
        /// </summary>
        /// <param name="path">The file path</param>
        public DroidFileSystemFile(string path)
        {
        ...
        /// <param name="toFolder">Only in use for UWP at the time Can be null otherwise</param>
        /// <param name="collisionOption">How to deal with collisions with existing files.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>
